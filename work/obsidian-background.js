...
function putImageData(imageData, x, y, sourceX, sourceY, sourceWidth, sourceHeight) {var _x6, _y6, _sourceX, _sourceY, _sourceWidth, _sourceHeight;
  if (isVectorish(x)) {
...
function draw(e) {
  ...
  let colorA = hsl(hueA, 100, 0);
  let colorB = hsl(hueB, 100, 0);
